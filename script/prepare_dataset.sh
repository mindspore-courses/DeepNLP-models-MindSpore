...
python3 -c "import nltk;nltk.download('gutenberg');nltk.download('brown');nltk.download('conll2002');nltk.download('timit');nltk.download('averaged_perceptron_tagger')"
